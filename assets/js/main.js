...
document.addEventListener('DOMContentLoaded', () => {
    ...
    playPrompt.innerHTML = '🎵 Click anywhere to start music 🎵';
    playPrompt.style.cssText = `
        ...
        z-index: 9999;
        font-family: 'Your Wedding Font', sans-serif;
        font-size: 10px;
        font-weight: bold;
        animation: promptFade 2s infinite;
        cursor: pointer;
    ...
    const startMusic = () => {
        audio.play()
            .then(() => {
                setUI(true);
                playPrompt.remove(); // Remove prompt after start
    ...
    // Also make prompt clickable
    playPrompt.addEventListener('click', (e) => {
        e.stopPropagation();
        startMusic();
    });
